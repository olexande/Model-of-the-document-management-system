...
public class LogOfSystem {
    //запись лога
    public static void writeLog(String pathToApplication, LogType type, String message) {
        //todo: определить каталог приложения
        //имя лога: текущая дата. При необходимости записи добавляются в файл
        try (FileWriter fw = new FileWriter(pathToApplication + "\\base\\logs\\" + LocalDate.now() + ".log", true)) {
